...
function StartTheProcess()
{
	...
	# ---------------------------------
		...
		bash vst-install.sh --nginx yes --apache yes --phpfpm no --vsftpd yes --proftpd no --exim yes --dovecot yes --spamassassin yes --clamav no --named yes --iptables no --fail2ban no --mysql yes --postgresql no --remi yes --softaculous $vSoftaculousFull --quota no --hostname $vHostname --email $vEmail --password $vPassword
