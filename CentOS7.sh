...
function StartTheProcess()
{
	...
	# ---------------------------------
		...
		bash vst-install.sh --nginx no --phpfpm yes --apache yes --vsftpd yes --proftpd no --exim yes --dovecot yes --spamassassin yes --clamav no --named yes --iptables no --fail2ban no --mysql yes --postgresql no --remi yes --softaculous $vSoftaculousFull --quota no --hostname $vHostname --email $vEmail --password $vPassword
